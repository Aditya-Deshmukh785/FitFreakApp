...
/**
 * Servlet implementation class feestructure
 */
@WebServlet("/feestructure")
public class feestructure extends HttpServlet {
		...
		//response.getWriter().append("Served at: ").append(request.getContextPath());
		 response.setContentType("text/html;charset=UTF-8");
	        ...
	        try {
	            ...
	            out.println("<table>");
	            out.println("<tr><th>Plan Name</th><th>Price</th><th>Duration</th><th>Description</th></tr>");
	        ...
	        out.println("<div class='back-btn'><button onclick=\"window.location.href='login.html'\">Back</button></div>");
