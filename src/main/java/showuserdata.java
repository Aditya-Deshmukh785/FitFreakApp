	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//response.getWriter().append("Served at: ").append(request.getContextPath());
		 response.setContentType("text/html;charset=UTF-8");
	        ...
	        // HTML Theme Header
	        out.println("<html><head><title>All Users - FitFreak</title>");
	        out.println("<style>");
	        ...
	        out.println("<h1>User-Data FitFreak App</h1>");
	        ...
	        try {
	        	...
	        	out.println("<table>");
	        	out.println("<tr>");
	        	out.println("<th>ID</th><th>NAME</th><th>E-MAIL</th><th>PHONE</th><th>USERNAME</th><th>PLAN</th></tr>");
